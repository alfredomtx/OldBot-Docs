...
### use_sqm(`direção`)
Realiza a ação de `nUse`n no SQM, pode ser utilizado para abrir portas, subir escadas(Ladder), etc. O diferencial dessa função ao invés de simplesmente clicar com o botão direito no SQM, é que a ação de `nUse`n será realizada mesmo se houver algum player/monstro ou item em cima do SQM.
